...
export type ResourceType = 'vm' | 'storage' | 'network' | 'database' | 'load-balancer' | 'firewall' | 'vpn' | 'client' | 'server' | 'hardware' | 'resource-group' | 'function' | 'container' | 'kubernetes' | 'other';
